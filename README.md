...
Мобильное приложение работает на React Native и TypeScript. Реализованы навигация, локальный каталог видео и экран информации о выбранном видео; остальные продуктовые сценарии развиваются поэтапно.
...
В мобильной части реализованы базовая навигация, каталог и экран деталей на локальных данных. Плеер и остальные продуктовые сценарии ещё не реализованы, backend отсутствует. Документы с будущими решениями явно помечены как целевая архитектура, чтобы не смешивать планы с фактическим состоянием.
