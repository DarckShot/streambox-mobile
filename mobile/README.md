...
В приложение подключён React Navigation: корневой native stack, нижняя панель вкладок и типизированные параметры маршрутов. Все запланированные маршруты представлены экранами-заглушками; продуктовая логика и видеоплеер ещё не реализованы. `App.tsx` настраивает safe area, системную тему, `StatusBar` и корневой контейнер навигации.
